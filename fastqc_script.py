...
# part 2: get list of FASTQ files and implement batch execution
# get list of FASTQ files
file_list = os.listdir(seq_dir)
print('# got list of files in: ' + seq_dir)

# create the command string for each sequence and implement
for seq in file_list:
	command = 'fastqc ' + seq_dir + '/' + seq
	print(command)
	os.system(command)
# part 3: move FASTQ files into a dedicated directory
# mv html and zip files out of sequence directory into FASTQC directory
